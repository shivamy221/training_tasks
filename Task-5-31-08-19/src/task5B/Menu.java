...
public class Menu {
	...
	public static void viewSortedEmployees() {
		
		System.out.println("\n Select Order by : ");
		System.out.println("On Which field (1.employee/2.ename/3.sal) : ");
		int choiceField= scn.nextInt();
		System.out.println("Order by(1.asc/2.desc) : ");
		int choiceOrder= scn.nextInt();
		Collections.sort(list,new SortEmployees(choiceField,choiceOrder));
		Menu.viewEmployees();
	}
