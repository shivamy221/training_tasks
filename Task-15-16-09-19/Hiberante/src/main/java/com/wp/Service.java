...
public class Service {
	...
	public static void updateEmployee() {
		...
		/*
		 * Session session = sf.openSession(); Transaction t =
		 * session.beginTransaction();
		 * 
		 * System.out.println("Enter employee no : "); int empno = scanner.nextInt();
		 * System.out.println("Enter employee name : "); String ename = scanner.next();
		 * System.out.println("Enter employee salary : "); int sal = scanner.nextInt();
		 * 
		 * Emp emp = new Emp(); session.get(Emp.class, empno);
		 * 
		 * session.update(emp); t.commit(); session.close();
		 * 
